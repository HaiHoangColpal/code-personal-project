const TEMPLATE_ID = "1sZK7YJXlTf7aauqzP99ZDiZDbDnShvkP"//"1Kd0zQVnGvU0Qlfkugbz3fmX1kG_m-jyD"; //https://drive.google.com/file/d/1Kd0zQVnGvU0Qlfkugbz3fmX1kG_m-jyD/view?usp=drive_link
const OUTPUT_FOLDER = "1FnsnucctRzYmrp_IcdoQrwy9Ab4CQQY9";
const FONT_ID = "1jsRm-j6N4o7JMmp7agdlSlUemUnCgH-_"; //https://drive.google.com/file/d/1jsRm-j6N4o7JMmp7agdlSlUemUnCgH-_/view?usp=drive_link


//https://drive.google.com/file/d/1sZK7YJXlTf7aauqzP99ZDiZDbDnShvkP/view?usp=sharing
...
function copyPlan() {
  // try{
    ...
    const ID_Plan = '12uKooSuVON_k398uR0Yo40irKcJfCGQXcX7XMsCH0io'
...
function copyMasterDataLE() {
  const ss = SpreadsheetApp.getActiveSpreadsheet();
  const ID_LE = '1cRnahSsDK_jpL6e6N14YW0-mwj0xim_jb72xUmcnCAc'
...
function copyMasterDataMAKT() {
  const ss = SpreadsheetApp.getActiveSpreadsheet();
  const ID_MAKT = '1cRnahSsDK_jpL6e6N14YW0-mwj0xim_jb72xUmcnCAc'
...
//   const ss = SpreadsheetApp.getActiveSpreadsheet();
//   const ID_ZMNU = '1cRnahSsDK_jpL6e6N14YW0-mwj0xim_jb72xUmcnCAc'
